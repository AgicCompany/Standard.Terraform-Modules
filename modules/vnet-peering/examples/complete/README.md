# VNet Peering - Complete Example

Deploys bidirectional VNet peering with forwarded traffic enabled and all options configured.
...
| <a name="output_peering_name"></a> [peering\_name](#output\_peering\_name) | n/a |
| <a name="output_public_peering_id"></a> [public\_peering\_id](#output\_public\_peering\_id) | n/a |
