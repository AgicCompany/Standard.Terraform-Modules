...
```hcl
module "web_app" {
  source = "git::https://github.com/AgicCompany/Standard.Terraform-Modules.git//modules/linux-web-app?ref=linux-web-app/v2.0.0"
...
| <a name="input_connection_strings"></a> [connection\_strings](#input\_connection\_strings) | Connection strings. Key is used as the connection string name. | <pre>map(object({<br/>    type  = string<br/>    value = string<br/>  }))</pre> | `{}` | no |
