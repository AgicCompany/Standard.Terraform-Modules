...
variables {
  ...
  location                   = "westeurope"
  name                       = "func-test-weu-001"
  service_plan_id            = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg/providers/Microsoft.Web/serverFarms/asp-test"
  storage_account_name       = "sttestweu001"
  storage_account_access_key = "fake-access-key"
