# PostgreSQL Flexible Server - Complete Example

Deploys a PostgreSQL Flexible Server with VNet integration, multiple databases, server configurations, and custom maintenance window.
