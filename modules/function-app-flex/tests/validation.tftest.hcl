...
variables {
  ...
  location                   = "westeurope"
  name                       = "funcflex-test-weu-001"
  service_plan_id            = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg/providers/Microsoft.Web/serverFarms/asp-fc1-test"
  runtime_name               = "python"
  runtime_version            = "3.11"
  storage_container_endpoint = "https://sttestweu001.blob.core.windows.net/deploy-container"
