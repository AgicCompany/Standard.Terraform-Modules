...
| <a name="input_enable_public_access"></a> [enable\_public\_access](#input\_enable\_public\_access) | Allow public network access to the Function App (default: disabled for security). | `bool` | `false` | no |
