...
| <a name="input_enable_http2"></a> [enable\_http2](#input\_enable\_http2) | Enable HTTP/2 | `bool` | `false` | no |
...
| <a name="input_ssl_policy_name"></a> [ssl\_policy\_name](#input\_ssl\_policy\_name) | Predefined SSL policy name. Default enforces TLS 1.2+ with modern ciphers. | `string` | `"AppGwSslPolicy20220101"` | no |
