...
variables {
  ...
  location            = "westeurope"
  name                = "apim-test-weu-001"
  publisher_name      = "Test Publisher"
  publisher_email     = "apim-admin@example.com"
  subnet_id           = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg/providers/Microsoft.Network/virtualNetworks/vnet-test/subnets/snet-apim"
  private_dns_zone_id = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg/providers/Microsoft.Network/privateDnsZones/privatelink.azure-api.net"
}
