...
variable "container_app_job_job" {}
...
module "container_app_job_job" {
  source = "git::https://github.com/AgicCompany/Standard.Terraform-Modules.git//modules/container-app-job?ref=container-app-job/v1.1.1"

  resource_group_name          = var.container_app_job_job.resource_group_name
  location                     = var.container_app_job_job.location
  name                         = var.container_app_job_job.name
  tags                         = var.container_app_job_job.tags
  replica_timeout_in_seconds   = var.container_app_job_job.replica_timeout_in_seconds
  container                    = var.container_app_job_job.container
  schedule_trigger_config      = var.container_app_job_job.schedule_trigger_config
...
output "container_app_job_job_id" {
  value = module.container_app_job_job.id
}
output "container_app_job_job_name" {
  value = module.container_app_job_job.name
}
output "container_app_job_job_event_stream_endpoint" {
  value = module.container_app_job_job.event_stream_endpoint
}
